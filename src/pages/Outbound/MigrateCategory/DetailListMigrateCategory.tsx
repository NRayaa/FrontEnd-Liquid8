...
const DetailListMigrateCategory = () => {
    const { id } = useParams();
        ...
        <>
            <ul className="flex space-x-2 rtl:space-x-reverse">
                ...
                <li className="before:content-['/'] ltr:before:mr-2 rtl:before:ml-2">
                    <span>Detail Product List Migrate Category</span>
                </li>
            </ul>{' '}
            <div className="mt-10 p-6 panel">
                <div className="flex items-center justify-between mb-6">
                    <h1 className="text-xl font-bold">Detail Product List Migrate Category</h1>
                    <Link to="/outbound/category_migrate/list_category_migrate">
...
export default DetailListMigrateCategory;
