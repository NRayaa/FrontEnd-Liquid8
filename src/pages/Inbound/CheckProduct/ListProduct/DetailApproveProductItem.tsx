...
const DetailApproveProductItem = () => {
        ...
        <>
            ...
            <div className="mt-10 p-6 panel">
                <div className="flex items-center justify-between mb-6">
                    ...
                    <Link to="/inbound/check_product/product_approve_document" state={{ code_document: dataDetailProduct?.code_document }}>
...
export default DetailApproveProductItem;
