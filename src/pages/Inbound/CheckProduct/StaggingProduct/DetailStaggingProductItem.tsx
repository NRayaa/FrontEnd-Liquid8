...
const DetailStaggingProductItem = () => {
...
<ul className="flex space-x-2 rtl:space-x-reverse">
                ...
                <li className="before:content-['/'] ltr:before:mr-2 rtl:before:ml-2">
                    <span>Detail Product Stagging</span>
                </li>
            </ul>            <div className="mt-10 p-6 panel">
                <div className="flex items-center justify-between mb-6">
                    <h1 className="text-xl font-bold">Detail Product</h1>
                    <Link to="/inbound/check_product/product_stagging" state={{ code_document: dataDetailProduct?.code_document }}>
...
export default DetailStaggingProductItem;
