...
interface ScanResultBarcodePrint {
    oldPrice: string;
    newPrice: string;
    barcode: string;
    category: string;
...
const ScanResultBarcodePrinted: React.FC<ScanResultBarcodePrint> = ({ oldPrice, newPrice, barcode, category, isBundle }) => {
...
export default ScanResultBarcodePrinted;
