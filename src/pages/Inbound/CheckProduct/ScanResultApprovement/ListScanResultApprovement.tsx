...
const ListScanResultApprovement = () => {
        ...
        <>
            <ul className="flex space-x-2 rtl:space-x-reverse">
                ...
                <li className="before:content-['/'] ltr:before:mr-2 rtl:before:ml-2">
                    <span>Scan Result Approvement</span>
                </li>
            </ul>{' '}
            <div className="panel mt-6 min-h-[450px]">
                <h5 className="font-semibold text-lg dark:text-white-light mb-5">List Scan Result Approvement</h5>
                            ...
                            },
                            {
                                ...
                                render: (item: ProductStaggingItem) => (
                                    <div className="flex items-center w-max mx-auto gap-6">
                                        <Link to={`/inbound/check_product/scan_result_approve/detail/${item.id}`} state={{ id: item.id }}>
...
export default ListScanResultApprovement;
