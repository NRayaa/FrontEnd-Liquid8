...
// import { useEditDetailProductMutation, useGetAllProductNewQuery, useLazyUpdatePriceByProductOldQuery } from '../../../store/services/productNewApi';
import { Link, useNavigate, useParams } from 'react-router-dom';
import toast from 'react-hot-toast';
import { useGetDetailApprovementStaggingQuery } from '../../../../store/services/staggingApi';
import { useEditDetailProductMutation, useGetAllProductNewQuery, useLazyUpdatePriceByProductOldQuery } from '../../../../store/services/productNewApi';
...
import BarcodePrinted from '../../../Storage/Product/BarcodePrinted';
import { formatRupiah } from '../../../../helper/functions';

const DetailScanResultApprovement = () => {
    const { id } = useParams();
    const navigate = useNavigate();
    const { data, isSuccess, refetch, isError } = useGetDetailApprovementStaggingQuery(id);
        ...
        <>
            <ul className="flex space-x-2 rtl:space-x-reverse">
                ...
                <li className="text-primary hover:underline before:content-['/'] ltr:before:mr-2 rtl:before:ml-2">
                    <Link to="/inbound/check_product/scan_result_approve">
                        <span>Scan Result</span>
                    </Link>
                </li>
                <li className="before:content-['/'] ltr:before:mr-2 rtl:before:ml-2">
                    <span>Detail Scan Result Approvement</span>
                </li>
            </ul>{' '}
            <div className="mt-10 p-6 panel">
                <div className="flex items-center justify-between mb-6">
                    <h1 className="text-xl font-bold">Detail Product Scan Result Approve</h1>
                    <Link to={'/inbound/check_product/scan_result_approve'}>
...
export default DetailScanResultApprovement;
