...
const DetailProductCategory = () => {
    ...
    return (
        <>
            <BreadCrumbs base="Storage" basePath="/storage/product/category" sub="Produk" subPath="/storage/product/category" current="Detail Produk" />
            <div className="mt-10 p-6 panel">
                <div className="flex items-center justify-between mb-6">
                    <h1 className="text-xl font-bold">Detail Product</h1>
                    <Link to="/storage/product/category">
