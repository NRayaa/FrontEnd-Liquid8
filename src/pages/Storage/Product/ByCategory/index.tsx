...
const ProductByCategory = () => {
    ...
    const { data, isError, refetch, isSuccess } = useProductByCategoryQuery({ page, q: search });
    ...
    return (
        <>
            <BreadCrumbs base="Storage" basePath="storage/product/category" current="Produk" />
                            ...
                            },
                            {
                                ...
                                render: (item: NewProductItem) => (
                                    <div className="flex items-center w-max mx-auto gap-6">
                                        <Link to={`/storage/product/category/${item.id}`}>
