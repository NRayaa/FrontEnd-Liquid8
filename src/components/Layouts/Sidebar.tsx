                ...
                <div className="bg-white dark:bg-black h-full">
                    ...
                    <PerfectScrollbar className="h-[calc(100vh-80px)] relative">
                        <ul className="relative font-semibold space-y-0.5 p-4 py-0">
                            <li className="menu nav-item">
                                ...
                                <AnimateHeight duration={300} height={currentMenu === 'dashboard' ? 'auto' : 0}>
                                    <ul className="sub-menu text-gray-500">
                                        <li>
                                            <NavLink to="/dashboard/storage_report">{t('Storage Report')}</NavLink>
                                        </li>
                                        <li>
                                            <NavLink to="/dashboard/general_sale">{t('General Sale')}</NavLink>
                                        </li>
                                        <li>
                                            <NavLink to="/dashboard/analytic_sale">{t('Analytic Sale')}</NavLink>
                                        </li>
                                    </ul>
                                </AnimateHeight>
                            </li>
                                    ...
                                    <li className="nav-item">
                                        ...
                                        <AnimateHeight duration={300} height={currentMenu === 'check_product' ? 'auto' : 0}>
                                            <ul className="sub-menu text-gray-500">
                                                ...
                                                <li>
                                                    <NavLink to="/inbound/check_product/product_approve_document">{'Product Approve'}</NavLink>
                                                </li>
                                                <li>
                                                ...
                                                <li>
                                                    <NavLink to="/inbound/check_product/product_input">{'Product Input'}</NavLink>
                                                </li>
                                            </ul>
                                        </AnimateHeight>
                                    </li>
                            ...
                            <li className="menu nav-item">
                                ...
                                <AnimateHeight duration={300} height={currentMenu === 'expired_product' ? 'auto' : 0}>
                                    <ul className="sub-menu text-gray-500">
                                        ...
                                        <li>
                                            <NavLink to="/storage/expired_product/list_bkl">{'BKL'}</NavLink>
                                        </li>
                                    </ul>
                                </AnimateHeight>
                            </li>
                            ...
                            <li className="menu nav-item">
                                <button type="button" className={`${currentMenu === 'pallet' ? 'active' : ''} nav-link group w-full`} onClick={() => toggleMenu('pallet')}>
                                    <div className="flex items-center">
                                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path
                                    ...
                                    <div className={currentMenu === 'pallet' ? 'rotate-90' : 'rtl:rotate-180'}>
                                        <svg width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M9 5L15 12L9 19" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                                        </svg>
                                    </div>
                                </button>
                                <AnimateHeight duration={300} height={currentMenu === 'pallet' ? 'auto' : 0}>
                                    <ul className="sub-menu text-gray-500">
                                        <li>
                                            <NavLink to="/storage/pallet">{'Pallet'}</NavLink>
                                        </li>
                                        <li>
                                            <NavLink to="/storage/warehouse">{'Warehouse'}</NavLink>
                                        </li>
                                        <li>
                                            <NavLink to="/storage/kondisi">{'Kondisi'}</NavLink>
                                        </li>
                                        <li>
                                            <NavLink to="/storage/status">{'Status'}</NavLink>
                                        </li>
                                        <li>
                                            <NavLink to="/storage/merk">{'Merk'}</NavLink>
                                        </li>
                                        <li>
                                            <NavLink to="/storage/kendaraan">{'Kendaraan'}</NavLink>
                                        </li>
                                    </ul>
                                </AnimateHeight>
                            </li>
                                ...
                                <li className="menu nav-item">
                                    <button type="button" className={`${currentMenu === 'list_migrate' ? 'active' : ''} nav-link group w-full`} onClick={() => toggleMenu('list_migrate')}>
                                        <div className="flex items-center">
                                            ...
                                            <span className="ltr:pl-3 rtl:pr-3 text-black dark:text-[#506690] dark:group-hover:text-white-dark">{t('Migrate Color')}</span>
                                        </div>
                                ...
                                <li className="menu nav-item">
                                    ...
                                    >
                                        <div className="flex items-center">
                                            ...
                                            <span className="ltr:pl-3 rtl:pr-3 text-black dark:text-[#506690] dark:group-hover:text-white-dark">{t('Migrate Category')}</span>
                                        </div>
                                    ...
                                    <AnimateHeight duration={300} height={currentMenu === 'list_category_migrate' ? 'auto' : 0}>
                                        <ul className="sub-menu text-gray-500">
                                            <li>
                                                <NavLink to="/outbound/category_migrate/category_migrate">{'Category Migrate'}</NavLink>
                                            </li>
                                            <li>
                                                <NavLink to="/outbound/category_migrate/list_category_migrate">{'List Category Migrate'}</NavLink>
                                            </li>
                                        </ul>
                                    </AnimateHeight>
                                </li>
                            ...
                            <ul>
                                ...
                                <li className="menu nav-item">
                                    <NavLink to="/akun/akun/list_akun_panel" className="group">
                                        <div className="flex items-center">
                                            <svg stroke="currentColor" fill="currentColor" strokeWidth="0" viewBox="0 0 384 512" height="200px" width="200px" xmlns="http://www.w3.org/2000/svg">
                                                <path d="M192 0c-41.8 0-77.4 26.7-90.5 64H64C28.7 64 0 92.7 0 128V448c0 35.3 28.7 64 64 64H320c35.3 0 64-28.7 64-64V128c0-35.3-28.7-64-64-64H282.5C269.4 26.7 233.8 0 192 0zm0 64a32 32 0 1 1 0 64 32 32 0 1 1 0-64zM128 256a64 64 0 1 1 128 0 64 64 0 1 1 -128 0zM80 432c0-44.2 35.8-80 80-80h64c44.2 0 80 35.8 80 80c0 8.8-7.2 16-16 16H96c-8.8 0-16-7.2-16-16z"></path>
                                            </svg>

                                            <span className="ltr:pl-3 rtl:pr-3 text-black dark:text-[#506690] dark:group-hover:text-white-dark">{'Panel SPV'}</span>
                                        </div>
                                    </NavLink>
                                </li>
                                <li className="menu nav-item">
